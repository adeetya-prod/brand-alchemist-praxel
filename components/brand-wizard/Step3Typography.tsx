  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input value={values.fontHeading} onChange={e => onChange({ fontHeading: e.target.value })} placeholder="Playfair Display" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500" />
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Body Font</label>
        <input value={values.fontBody} onChange={e => onChange({ fontBody: e.target.value })} placeholder="Inter" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500" />
      </div>
    </div>
  )
}
